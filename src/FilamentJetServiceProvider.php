...
use Mstfkhazaal\FilamentJet\Filament\Pages\CreateTeam as CreateTeamPage;
use Mstfkhazaal\FilamentJet\Console\InstallCommand;
use Mstfkhazaal\FilamentJet\Contracts\TwoFactorAuthenticationProvider as TwoFactorAuthenticationProviderContract;
use Mstfkhazaal\FilamentJet\Filament\Pages\Account;
use Mstfkhazaal\FilamentJet\Filament\Pages\ApiTokens;
use Mstfkhazaal\FilamentJet\Filament\Pages\Auth\EmailVerification\EmailVerificationPrompt;
use Mstfkhazaal\FilamentJet\Filament\Pages\Auth\Login;
use Mstfkhazaal\FilamentJet\Filament\Pages\Auth\PasswordReset\RequestPasswordReset;
use Mstfkhazaal\FilamentJet\Filament\Pages\Auth\PasswordReset\ResetPassword;
use Mstfkhazaal\FilamentJet\Filament\Pages\Auth\Register;
use Mstfkhazaal\FilamentJet\Filament\Pages\Auth\TwoFactorLogin;
use Mstfkhazaal\FilamentJet\Filament\Pages\TeamSettings;
use Mstfkhazaal\FilamentJet\Http\Livewire\ApiTokensTable;
use Mstfkhazaal\FilamentJet\Http\Livewire\LogoutOtherBrowserSessions;
use Mstfkhazaal\FilamentJet\Http\Livewire\PrivacyPolicy;
use Mstfkhazaal\FilamentJet\Http\Livewire\SwitchableTeam;
use Mstfkhazaal\FilamentJet\Http\Livewire\TermsOfService;
use Mstfkhazaal\FilamentJet\Http\Responses\Auth\Contracts\EmailVerificationResponse as EmailVerificationResponseContract;
use Mstfkhazaal\FilamentJet\Http\Responses\Auth\Contracts\PasswordResetResponse as PasswordResetResponseContract;
use Mstfkhazaal\FilamentJet\Http\Responses\Auth\Contracts\TwoFactorLoginResponse as TwoFactorLoginResponseContract;
use Mstfkhazaal\FilamentJet\Http\Responses\Auth\EmailVerificationResponse;
use Mstfkhazaal\FilamentJet\Http\Responses\Auth\PasswordResetResponse;
use Mstfkhazaal\FilamentJet\Http\Responses\Auth\TwoFactorLoginResponse;
