...
use Mstfkhazaal\FilamentJet\Http\Controllers\Auth\EmailVerificationController;
        ...
        Route::name('auth.')
            ...
            ->group(function () {
                ...
                if (Features::enabled(Features::twoFactorAuthentication())) {
                    Route::get('/two-factor-login', \Mstfkhazaal\FilamentJet\Filament\Pages\Auth\TwoFactorLogin::class)->name('two-factor.login');
                }
